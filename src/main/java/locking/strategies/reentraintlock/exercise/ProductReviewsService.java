package locking.strategies.reentraintlock.exercise;
import java.util.*;
...
public class ProductReviewsService {
    ...
    ReadWriteLock productReadWriteLock=new ReentrantReadWriteLock();
    Lock readLock=productReadWriteLock.readLock();
    Lock writeLock=productReadWriteLock.writeLock();
